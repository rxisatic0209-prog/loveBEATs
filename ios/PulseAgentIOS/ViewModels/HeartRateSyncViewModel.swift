    ...
    func uploadLatestOnce() {
        Task {
            do {
                ...
                let response = try await backendClient.uploadHeartRate(baseURL: config.baseURL, payload: payload)
