...
final class HealthKitHeartRateService {
    ...
    func startObserving(onUpdate: @escaping @Sendable (HeartRateSample) async -> Void) {
        ...
        observerQuery = HKObserverQuery(sampleType: heartRateType, predicate: nil) { [weak self] _, completionHandler, error in
            ...
            self.runAnchoredQuery(onUpdate: onUpdate)
            completionHandler()
        }
        ...
        runAnchoredQuery(onUpdate: onUpdate)
    }
    ...
    private func runAnchoredQuery(onUpdate: @escaping @Sendable (HeartRateSample) async -> Void) {
    ...
    private static func toHeartRateSample(_ sample: HKQuantitySample) -> HeartRateSample {
